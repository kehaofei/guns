...
import com.cetccloud.ciem.modular.flowable.service.IWorkFlowService;
...
//        Expense expense = this.selectById(expenseId);
        List<ProcessInstance> list = runtimeService.createProcessInstanceQuery().processInstanceId(processId/*expense.getProcessId()*/).list();
        for (ProcessInstance processInstance : list) {
            if (processInstance.getId().equals(processId/*expense.getProcessId()*/)) {
...
//        }
    ...
    @Override
    @DataSource(name = DatasourceEnum.DATA_SOURCE_BIZ)
    public void printProcessImage(String processId/*Integer expenseId*/) throws IOException {
//        Expense expense = this.selectById(expenseId);
